...
def parse_option():
    ...
    opt.model_path = './save/SigSiam/{}_models'.format(opt.dataset)
    opt.tb_path = './save/SigSiam/{}_tensorboard'.format(opt.dataset)
...
def set_loader(opt):
    ...
    if opt.dataset == 'XMU_Motor_signal':
        train_dataset = NoTransformMotorSignalDataset(opt.data_folder + 'train/')
        val_dataset = NoTransformMotorSignalDataset(opt.data_folder + 'test/')
    else:
